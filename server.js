      ...
      <body>
        <div class="container">
          ...
          <div class="buttons">
            ...
            <a href="https://tennesseefeeds.com/index.html?article=${safeTitle.toLowerCase().replace(/[^a-z0-9]+/g, '-').slice(0, 50)}&title=${safeTitle.toLowerCase().replace(/[^a-z0-9]+/g, '-').slice(0, 50)}" class="button" style="background-color: #666;">View on TennesseeFeeds</a>
          </div>
