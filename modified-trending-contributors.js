...
(function() {
    ...
    function initTrendingContributors() {
        ...
        function setupComponent() {
            ...
            // MODIFICATION: First look for the shared-articles container's parent
            const sharedArticlesContainer = document.querySelector('.shared-articles');
            if (sharedArticlesContainer && sharedArticlesContainer.parentElement) {
                targetElement = sharedArticlesContainer.parentElement;
                console.log('Trending Contributors will be placed in same column as Recently Shared');
            } 
            // Fallback to original logic if shared-articles not found
            else {
